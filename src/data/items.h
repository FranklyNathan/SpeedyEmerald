...
// Type-boosting Held Items
    ...
    {
        .name = _("Metal Coat"),
        .price = (I_PRICE >= GEN_9) ? 3000 : ((I_PRICE >= GEN_7) ? 2100 : 100),
...
// Status Orbs
    ...
    {
        .name = _("Flame Orb"),
        .price = (I_PRICE >= GEN_9) ? 15000 : ((I_PRICE >= GEN_7) ? 800 : 200),
...
// Misc. Held Items
    ...
    {
        .name = _("King's Rock"),
        .price = (I_PRICE >= GEN_9) ? 10000 : ((I_PRICE >= GEN_7) ? 2100 : 100),
    ...
    {
        .name = _("Razor Claw"),
        .price = (I_PRICE >= GEN_9) ? 15000 : ((I_PRICE >= GEN_7) ? 2000 : 2100),
        .holdEffect = HOLD_EFFECT_SCOPE_LENS,
        .description = COMPOUND_STRING(
            "A hooked claw that\n"
            "ups the holder's\n"
    ...
    {
        .name = _("Razor Fang"),
        .price = (I_PRICE >= GEN_9) ? 15000 : ((I_PRICE >= GEN_7) ? 2100 : 2100),
        .holdEffect = HOLD_EFFECT_FLINCH,
        .holdEffectParam = 10,
        .description = sKingsRockDesc,
        .pocket = POCKET_ITEMS,
...
// Berries
    ...
    [ITEM_LUM_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 400,

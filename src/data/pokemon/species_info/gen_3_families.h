...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_ROSELIA, CONDITIONS({IF_IN_MAPSEC, MAPSEC_SECRET_BASE})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CHIMECHO, CONDITIONS({IF_IN_MAPSEC, MAPSEC_SECRET_BASE})}),
    },
#endif //P_GEN_4_CROSS_EVOS
